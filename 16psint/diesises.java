...
// por lo que este archivo debería llamarse "DIESISES.java."

import java.io.*;
import java.math.*;

public class diesises {
	...
	public static void main(String args[]) throws IOException {
		...
		if (d==0) {
			...
			if (d>=0) {
				...
				System.out.println("La ecuación no tiene soluciones reales (tiene dos soluciones complejas distintas)");
				System.out.println("x1=i y x2=-i");
			}
		}
		// area de salidas
